...
public class OperacionesGeneroAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {
    ...
    private void montarVistaFormularioProducto(Producto producto) throws IOException {
        ...
        output.print("<input type='text' id='precio' class='form-control' placeholder='"+getText("producto.precio")+"' required value='"+producto.getPrecio()+"'/>");        
        output.print("</div>");   
        ...
        output.print("<input type='text' id='descripcion' class='form-control' placeholder='"+getText("producto.descripcion")+"' required value='"+producto.getDescripcion()+"'/>");          
        output.print("</div>");  
        ...
        output.print("<input type='button' id='botonAlta' class='btn btn-default btn-sm' value='"+getText("producto.alta")+"' disabled style='margin-right: 3px' />");
        output.print("<input type='button' id='botonActualizar' class='btn btn-default btn-sm' value='"+getText("producto.actualizar")+"' onclick='modificarProducto()' style='margin-right: 3px' />");        
        output.print("<input type='button' id='botonReiniciar' class='btn btn-default btn-sm' value='"+getText("producto.reiniciar")+"' onclick='reiniciar()' />");
        output.print("</div>");                   
        output.print("</fieldset>");
        output.print("</form>");        
    }
